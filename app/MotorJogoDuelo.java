...
public class MotorJogoDuelo implements MotorJogo {
    ...
    public MotorJogoDuelo() {
        ...
        personagens.add(new Humano(1, "Chung Lee", new Habilidade("Equilibrar pratos", 10)));
        personagens.add(new Humano(2, "Michael Jackson", new Habilidade("Dançar", 9)));
        personagens.add(new Animal(3, "Bidu", new Habilidade("Fingir de morto", 7)));
        personagens.add(new Animal(4, "Flipper", new Habilidade("Dançar sobre a água", 15)));
